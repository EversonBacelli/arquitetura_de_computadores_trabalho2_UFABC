...
programas = [
                'teste1_leitura_escrita_aritmetica.txt', 
                'teste2_operacoesLogicas.txt',
...
def carregarPrograma():
    ...
    for programa in programas:
        caminho_relativo = f"arquitetura_de_computadores_trabalho2_UFABC/programas/{programa}"
        ...
        if os.path.exists(caminho_absoluto):
            try:
                ...
                ALGORITMOS.append(linhas_do_programa)
